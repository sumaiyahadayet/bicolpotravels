	...
	<div class="col-lg-12">
		<!--begin::Portlet-->
          <div class="kt-portlet">
			...
			<!--begin::Form-->
               <form method="post" action="{{route('submit-add-offer')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                   @csrf
          ...
          <div class="form-group row">
             ...
             <textarea name="description"  class="form-control" rows="8" cols="50" >
             </textarea>
