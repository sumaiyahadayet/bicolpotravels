...
<div class="kt-subheader   kt-grid__item d-print-none" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Events and Offers</h3>
...
">
 <h2 style="padding-top:10px;">Events</h2>
            ...
            <div class="kt-portlet__head-wrapper">
                ...
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-event')}}" class="btn btn-success btn-icon-sm ">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($event->image)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>{{$event->title}}</td>
                    <td>{{$event->description}}</td>
                    <td>{{$event->order}}</td>
                    <td>
                     <a href="/admin/edit-event/{{$event->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-event/{{$event->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
...
"> <h2 style="padding-top:10px;">Offers</h2>
    ...
    ">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-offer')}}" class="btn btn-success btn-icon-sm ">
                            <i class="la la-plus"></i>
                            New Data
                        </a>
                    </div>
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($offer->image)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>{{$offer->title}}</td>
                    <td>{{$offer->description}}</td>
                    <td>{{$offer->order}}</td>
                    <td>
                     <a href="/admin/edit-offer/{{$offer->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-offer/{{$offer->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
