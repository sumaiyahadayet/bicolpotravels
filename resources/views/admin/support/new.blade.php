	...
	<div class="col-lg-12">
		<!--begin::Portlet-->
          <div class="kt-portlet">
			...
			<!--begin::Form-->
               <form method="post" action="{{route('submit-add-support')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                   @csrf
          ...
          <div class="form-group row">
             ...
             <textarea name="description"  class="form-control" rows="15" cols="50" >
             </textarea>
...
<div class="form-group row">
  ...
  <textarea name="descriptionb"  class="form-control" rows="15" cols="50" >
  </textarea>
</div>
</div>
<div class="form-group row">
						...
						<div class="col-lg-3">
							...
							<span class="form-text text-muted">Please enter  Order</span>
                              ...
                              <label class="col-lg-2 col-form-label">Type
                                   <p>(select 1 for big card<br>
                                        select 2 for small card)</p>
                              </label>
