...
<div class="kt-subheader   kt-grid__item d-print-none" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Skype</h3>
            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-skype')}}" class="btn btn-success btn-icon-sm ">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>{{$skype->order}}</td>
                    <td>
                     <a href="/admin/edit-skype/{{$skype->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-skype/{{$skype->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
                    <td>{{$skype->created_at}}</td>
