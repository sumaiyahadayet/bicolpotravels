	...
	<div class="col-lg-12">
		<!--begin::Portlet-->
          <div class="kt-portlet">
			...
			<!--begin::Form-->
               <form method="post" action="{{route('submit-add-bg')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                   @csrf
            ...
            <label class="col-lg-3 col-form-label">Event Background Image<br><p>(will take content height and full screen width)</p></label>
...
<label class="col-lg-3 col-form-label">Support Background Image<br><p>(will take content height and full screen width)</p></label>
<div class="col-lg-8 col-xl-8">
...
<span class="form-text text-muted">Allowed file types:  png, jpg, jpeg.</span>
 ...
 <div class="form-group row">
<label class="col-lg-3 col-form-label">Image<br><p>(will take content height and full screen width)</p></label>
<div class="col-lg-8 col-xl-8">
