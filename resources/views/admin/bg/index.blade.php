...
<div class="kt-subheader   kt-grid__item d-print-none" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Background Images</h3>
...
{{-- 
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-bg')}}" class="btn btn-success btn-icon-sm ">
        ...
        <table class="kt-datatable" id="html_table" width="100%">
            <thead>
                <tr>
                    ...
                    <th title="Field #5" class="kt-datatable__cell kt-datatable__cell--sort">Event Image</th>
                    <th title="Field #3">Support Image</th>
                    <th title="Field #4">Contact Image</th>
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($bg->imagea)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>
                        <img src="{{asset($bg->imageb)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>
                        <img src="{{asset($bg->imagec)}}" style="height:80px;width:auto" alt="">
                    </td>

                    <td>
                     <a href="/admin/edit-bg/{{$bg->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-bg/{{$bg->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
                    <td>{{$bg->created_at}}</td>
