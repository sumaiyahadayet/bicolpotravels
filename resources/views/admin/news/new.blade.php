...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form method="post" action="{{route('submit-add-news')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                @csrf
           ...
           <textarea name="title"  class="form-control" rows="8" cols="50" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            ...
                            <textarea name="description" class="form-control" rows="20" cols="70">
             </textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-xl-3">
                            ...
                            <textarea name="description2" class="form-control" rows="20" cols="70">
             </textarea>
