...
<div class="kt-subheader   kt-grid__item d-print-none" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Change Flight</h3>
...
">
 <h2 style="padding-top:10px;">Change Flight</h2>
            ...
            <div class="kt-portlet__head-wrapper">
                ...
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-change')}}" class="btn btn-success btn-icon-sm ">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>{{$change->order}}</td>
                    <td>
                     <a href="/admin/edit-change/{{$change->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-change/{{$change->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
...
"> <h2 style="padding-top:10px;">Change Flight Image</h2>
    ...
    ">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    {{-- <div class="dropdown dropdown-inline">
                        <a href="{{route('add-changei')}}" class="btn btn-success btn-icon-sm ">
                            <i class="la la-plus"></i>
                            New Data
                        </a>
                    </div> --}}
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($changei->image)}}" style="height:80px;width:auto" alt="">
                    </td>
<td>
                     <a href="/admin/edit-changei/{{$changei->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                    </td>
                    <td>{{$changei->created_at}}</td>
