	...
	<div class="col-lg-12">
		<!--begin::Portlet-->
          <div class="kt-portlet">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">
						Create New Facebook Address
					</h3>
				</div>
			</div>
			<!--begin::Form-->
               <form method="post" action="{{route('submit-add-fb')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                   @csrf
            ...
            <label class="col-lg-2 col-form-label">Facebook Address</label>
           <div class="col-lg-3 col-xl-3">

          <textarea name="number"  class="form-control" rows="8" cols="50" >
          </textarea>
