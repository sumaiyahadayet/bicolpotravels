            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-service')}}" class="btn btn-success btn-icon-sm ">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($service->image)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>{{$service->title}}</td>
                    <td>{{$service->description}}</td>
                    <td>{{$service->order}}</td>
                    <td>
                     <a href="/admin/edit-service/{{$service->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-service/{{$service->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
