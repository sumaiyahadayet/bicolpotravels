	...
	<div class="col-lg-12">
		<!--begin::Portlet-->
          <div class="kt-portlet">
			...
			<!--begin::Form-->
               <form method="post" action="{{route('update-banner')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                   @csrf
            ...
            <label class="col-lg-2 col-form-label">Image<br><p>(size:1682*500)</p></label>
         ...
         <input type="text" name="title" value="{{$data->title}}" class="form-control" >
          ...
          <div class="form-group row">
            ...
            <input type="text" name="caption" value="{{$data->caption}}" class="form-control" style="height:80px;" >
