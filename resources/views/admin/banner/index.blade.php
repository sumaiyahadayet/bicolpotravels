            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <div class="dropdown dropdown-inline">
                        <a href="{{route('add-banner')}}" class="btn btn-success btn-icon-sm ">
            ...
            <tbody>
              ...
              @endphp
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{asset($banner->image)}}" style="height:80px;width:auto" alt="">
                    </td>
                    <td>{{$banner->title}}</td>
                    <td>{{$banner->caption}}</td>
                    <td>{{$banner->order}}</td>
                    <td>
                     <a href="/admin/edit-banner/{{$banner->id}}" class="edit"><i class="la la-edit" data-toggle="tooltip" title="Edit"></i></a>
                     <a href="/admin/delete-banner/{{$banner->id}}" class="delete"> <i class="la la-trash" data-toggle="tooltip" title="Delete"></i> </a>
                    </td>
