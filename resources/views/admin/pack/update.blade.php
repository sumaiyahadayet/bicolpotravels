            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        Update Domestic Package
                    </h3>
                </div>
            </div>
            <!--begin::Form-->
            <form method="post" action="{{route('update-dompack')}}" class="kt-form kt-form--fit kt-form--label-right" enctype="multipart/form-data">
                @csrf
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3 col-xl-3">
                            ...
                            <input type="text" name="link" value="{{$data->link}}" class="form-control" style="height:80px;">
